...
function displayPics(){
  ...
  // The Answer that because the var is function scoped so we can use the var variable out of it is scope, but let is block scope so we cant use the let variable out of it's scope.
  console.log(viewed);
